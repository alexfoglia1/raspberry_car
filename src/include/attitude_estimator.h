...
namespace stateestimation
{
	...
	* Est.setGyroBias(3.1729775000000013, 0.8954749999999987, 2.0704599999999997);     // Optional: Use if you have prior knowledge about the gyroscope bias (Default: (0.0, 0.0, 0.0))
	* Est.setAccMethod(Est.ME_ABS_FUSED_YAW);        // Optional: Use if you wish to experiment with varying acc-only resolution methods
	*
	* // Main loop
	* while(true)
	* {
